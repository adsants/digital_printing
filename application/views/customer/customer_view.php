					...
					<div class="row">
						...
						<div class="col-sm-4 col-md-offset-2">
							<select class="form-control" name="field">
								<option <?php if($this->input->get('field')=='hp_customer') echo "selected"; ?> value="hp_customer">Berdasarkan No HP</option>
								<option <?php if($this->input->get('field')=='nama_customer') echo "selected"; ?> value="nama_customer">Berdasarkan Nama</option>
							</select>
						</div>
						<div class="col-sm-6">							
            ...
            <tbody>
				...
				<tr>
					<td align="center">
						...
						echo $this->template_view->getEditButton(base_url().$this->uri->segment(1)."/edit/".$showData->ID_CUSTOMER); 
						?>
						&nbsp;
						<?php
						////// cara ambil Button Delete (pesan yang ingin ditampilkan, link Delete)
						echo $this->template_view->getDeleteButton($showData->NAMA_CUSTOMER,base_url().$this->uri->segment(1)."/delete/".$showData->ID_CUSTOMER); 
						?>	
					</td>
					<td align="center"><?php echo $no; ?>.</td>
					<td ><?php echo $showData->NAMA_CUSTOMER; ?></td>
					<td ><?php echo $showData->HP_CUSTOMER; ?></td>
					<td ><?php echo $showData->ALAMAT_CUSTOMER; ?></td>
				</tr>
				<?php
				$no++;
				}
