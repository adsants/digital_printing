				...
				<div class="box-body">
					<form class="form-horizontal" id="form_standar">
						...
						<div class="form-group">
							...
							<div class="col-sm-2">
								<input type="input" class="form-control required number" maxlength="18" id="HP_CUSTOMER" name="HP_CUSTOMER">
							</div>
						</div>
						<div class="form-group">
							<label class="control-label col-sm-2" for="email">Alamat Customer :</label>
							<div class="col-sm-8">
								<input type="input" class="form-control required" id="ALAMAT_CUSTOMER" name="ALAMAT_CUSTOMER" >
							</div>
						</div>
						<div class="form-group">
